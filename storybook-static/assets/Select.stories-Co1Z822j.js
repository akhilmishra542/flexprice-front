 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ea=Ca("User",[["path",{d:"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2",key:"975kel"}],["circle",{cx:"12",cy:"7",r:"4",key:"17ys0d"}]]),u=[{value:"free",label:"Free",description:"$0 / month"},{value:"starter",label:"Starter",description:"$20 / month"},{value:"pro",label:"Pro",description:"$99 / month"},{value:"enterprise",label:"Enterprise",description:"Custom pricing"}],fa=[{value:"active",label:"Active",prefixIcon:a.jsx("span",{className:"h-2 w-2 rounded-full bg-green-500 inline-block"})},{value:"archived",label:"Archived",prefixIcon:a.jsx("span",{className:"h-2 w-2 rounded-full bg-gray-400 inline-block"})},{value:"draft",label:"Draft",prefixIcon:a.jsx("span",{className:"h-2 w-2 rounded-full bg-yellow-400 inline-block"})}],M=[{value:"paid",label:"Paid"},{value:"pending",label:"Pending"},{value:"draft",label:"Draft"},{value:"void",label:"Void",disabled:!0},{value:"failed",label:"Failed"}],_=[{value:"api_calls",label:"API Calls",description:"Per request metering",prefixIcon:a.jsx(Oa,{className:"h-4 w-4"})},{value:"seats",label:"Seats",description:"Per user metering",prefixIcon:a.jsx(Ea,{className:"h-4 w-4"})},{value:"storage",label:"Storage",description:"GB consumed",prefixIcon:a.jsx(Da,{className:"h-4 w-4"})},{value:"orgs",label:"Orgs",description:"Per org metering",prefixIcon:a.jsx(Pa,{className:"h-4 w-4"})},{value:"events",label:"Events",description:"Event stream metering",prefixIcon:a.jsx(ja,{className:"h-4 w-4"})}],Ia=[{value:"usd",label:"USD",suffixIcon:a.jsx("span",{className:"text-xs text-muted-foreground",children:"$"})},{value:"eur",label:"EUR",suffixIcon:a.jsx("span",{className:"text-xs text-muted-foreground",children:"€"})},{value:"gbp",label:"GBP",suffixIcon:a.jsx("span",{className:"text-xs text-muted-foreground",children:"£"})},{value:"inr",label:"INR",suffixIcon:a.jsx("span",{className:"text-xs text-muted-foreground",children:"₹"})}],Fa=[{id:"c1",name:"Acme Corp",email:"billing@acme.com"},{id:"c2",name:"Stripe Inc",email:"billing@stripe.com"},{id:"c3",name:"Vercel Ltd",email:"billing@vercel.com"},{id:"c4",name:"Linear GmbH",email:"billing@linear.app"},{id:"c5",name:"Notion AI",email:"billing@notion.so"}],c=e=>new Promise(r=>setTimeout(()=>{const s=Fa.filter(n=>!e.trim()||n.name.toLowerCase().includes(e.toLowerCase())||n.email.toLowerCase().includes(e.toLowerCase()));r(s.map(n=>({value:n.id,label:n.name,description:n.email,data:n})))},400)),o={valueExtractor:e=>e.id,labelExtractor:e=>e.name,descriptionExtractor:e=>e.email},Za={title:"Atoms/Select",component:l,parameters:{layout:"padded"},decorators:[e=>a.jsx("div",{className:"w-[320px] p-4",children:a.jsx(e,{})})],tags:["autodocs"],argTypes:{options:{control:!1},value:{control:"text"},placeholder:{control:"text"},label:{control:"text"},description:{control:"text"},error:{control:"text"},disabled:{control:"boolean"},isRadio:{control:"boolean"},required:{control:"boolean"},hideSelectedTick:{control:"boolean"}}},d={render:e=>{const[r,s]=t.useState("");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:u,placeholder:"Select a plan",label:"Billing Plan"},play:async({canvasElement:e})=>{const s=C(e).getByRole("combobox");await i(s).toBeInTheDocument(),await i(s).not.toBeDisabled()}},m={render:e=>{const[r,s]=t.useState("");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:u,label:"Billing Plan",description:"Choose the plan to assign this customer.",placeholder:"Select a plan",required:!0}},p={render:e=>{const[r,s]=t.useState("");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:fa,label:"Status",placeholder:"Select status",error:"Please select a status to continue."}},h={render:e=>{const[r,s]=t.useState("pro");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:u,label:"Current Plan",placeholder:"Select a plan"}},S={render:e=>{const[r,s]=t.useState("active");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:fa,label:"Status",disabled:!0},play:async({canvasElement:e})=>{const s=C(e).getByRole("combobox");await i(s).toBeDisabled()}},g={render:e=>{const[r,s]=t.useState("");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:_,label:"Feature",placeholder:"Select a feature"}},v={name:"Pattern — Currency picker",render:e=>{const[r,s]=t.useState("usd");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:Ia,label:"Currency",placeholder:"Select currency"}},x={render:e=>{const[r,s]=t.useState("");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:M,label:"Invoice Status",placeholder:"Filter by status",isRadio:!0}},b={render:e=>{const[r,s]=t.useState("");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:M,label:"Invoice Status",placeholder:"Select status"}},y={render:e=>{const[r,s]=t.useState("");return a.jsx(l,{...e,value:r,onChange:s})},args:{options:[],label:"Customer",placeholder:"No customers yet",noOptionsText:"No customers found."}},V={name:"SearchableSelect / Default",render:e=>{const[r,s]=t.useState("");return a.jsx("div",{className:"w-[320px] p-4",children:a.jsx(f,{...e,value:r,onChange:s})})},args:{options:_,label:"Feature",placeholder:"Select a feature",searchPlaceholder:"Search features...",description:"Choose the metering feature for this plan."}},w={name:"SearchableSelect / With error",render:e=>{const[r,s]=t.useState("");return a.jsx("div",{className:"w-[320px] p-4",children:a.jsx(f,{...e,value:r,onChange:s})})},args:{options:u,label:"Plan",placeholder:"Select a plan",error:"A plan selection is required."}},P={name:"SearchableSelect / Disabled",render:e=>{const[r,s]=t.useState("starter");return a.jsx("div",{className:"w-[320px] p-4",children:a.jsx(f,{...e,value:r,onChange:s})})},args:{options:u,label:"Plan",disabled:!0},play:async({canvasElement:e})=>{const s=C(e).getByRole("button");await i(s).toBeDisabled()}},j={name:"SearchableSelect / Radio style",render:e=>{const[r,s]=t.useState("");return a.jsx("div",{className:"w-[320px] p-4",children:a.jsx(f,{...e,value:r,onChange:s})})},args:{options:M,label:"Invoice Status",placeholder:"Filter by status",isRadio:!0,searchPlaceholder:"Search status..."}},D={name:"AsyncSearchableSelect / Default",render:()=>{const[e,r]=t.useState(void 0);return a.jsxs("div",{className:"w-[320px] p-4",children:[a.jsx(N,{search:{searchFn:c,placeholder:"Search customers..."},extractors:o,display:{label:"Customer",placeholder:"Select a customer",description:"Search by name or email."},value:e,onChange:r}),e&&a.jsxs("p",{className:"mt-2 text-xs text-muted-foreground",children:["Selected: ",a.jsx("strong",{children:e.name})," (",e.email,")"]})]})}},O={name:"AsyncSearchableSelect / With error",render:()=>{const[e,r]=t.useState(void 0);return a.jsx("div",{className:"w-[320px] p-4",children:a.jsx(N,{search:{searchFn:c},extractors:o,display:{label:"Customer",placeholder:"Select a customer",error:"A customer selection is required."},value:e,onChange:r})})}},E={name:"AsyncSearchableSelect / Disabled",render:()=>{const[e]=t.useState({id:"c1",name:"Acme Corp",email:"billing@acme.com"});return a.jsx("div",{className:"w-[320px] p-4",children:a.jsx(N,{search:{searchFn:c},extractors:o,display:{label:"Customer",placeholder:"Select a customer"},value:e,onChange:()=>{},disabled:!0})})},play:async({canvasElement:e})=>{const s=C(e).getByRole("button");await i(s).toBeDisabled()}},I={name:"AsyncSearchableSelect / Radio style",render:()=>{const[e,r]=t.useState(void 0);return a.jsx("div",{className:"w-[320px] p-4",children:a.jsx(N,{search:{searchFn:c},extractors:o,display:{label:"Customer",placeholder:"Select a customer"},options:{isRadio:!0},value:e,onChange:r})})}},F={name:"AsyncMultiSearchableSelect / Default",render:()=>{const[e,r]=t.useState([]);return a.jsxs("div",{className:"w-[400px] p-4",children:[a.jsx(A,{search:{searchFn:c,placeholder:"Search customers..."},extractors:o,display:{label:"Customers",placeholder:"Select customers",description:"Select one or more customers to assign."},value:e,onChange:r}),e.length>0&&a.jsxs("p",{className:"mt-2 text-xs text-muted-foreground",children:[e.length," selected: ",e.map(s=>s.name).join(", ")]})]})}},T={name:"AsyncMultiSearchableSelect / Pre-selected values",render:()=>{const[e,r]=t.useState([{id:"c1",name:"Acme Corp",email:"billing@acme.com"},{id:"c2",name:"Stripe Inc",email:"billing@stripe.com"},{id:"c3",name:"Vercel Ltd",email:"billing@vercel.com"},{id:"c4",name:"Linear GmbH",email:"billing@linear.app"}]);return a.jsxs("div",{className:"w-[400px] p-4",children:[a.jsx(A,{search:{searchFn:c},extractors:o,display:{label:"Customers",placeholder:"Select customers"},options:{maxCount:3},value:e,onChange:r}),a.jsx("p",{className:"mt-2 text-xs text-muted-foreground",children:"4 selected — 3 shown as badges, 1 in +N overflow"})]})}},R={name:"AsyncMultiSearchableSelect / Disabled",render:()=>{const[e]=t.useState([{id:"c1",name:"Acme Corp",email:"billing@acme.com"}]);return a.jsx("div",{className:"w-[400px] p-4",children:a.jsx(A,{search:{searchFn:c},extractors:o,display:{label:"Customers",placeholder:"Select customers"},value:e,onChange:()=>{},disabled:!0})})},play:async({canvasElement:e})=>{const s=C(e).getByRole("button");await i(s).toBeDisabled()}},k={name:"AsyncMultiSearchableSelect / Empty state",render:()=>{const[e,r]=t.useState([]);return a.jsx("div",{className:"w-[400px] p-4",children:a.jsx(A,{search:{searchFn:c},extractors:o,display:{label:"Customers",placeholder:"No customers selected",error:"Select at least one customer."},options:{emptyText:"No customers match your search."},value:e,onChange:r})})}},B={name:"Overview — All Select variants",render:()=>{const[e,r]=t.useState(""),[s,n]=t.useState(""),[Na,Aa]=t.useState(void 0),[Va,wa]=t.useState([]);return a.jsxs("div",{className:"grid grid-cols-2 gap-6 p-4 w-[700px]",children:[a.jsxs("div",{children:[a.jsx("p",{className:"text-xs font-medium text-muted-foreground mb-2 uppercase tracking-wide",children:"Select (Radix)"}),a.jsx(l,{options:u,value:e,onChange:r,label:"Plan",placeholder:"Select a plan"})]}),a.jsxs("div",{children:[a.jsx("p",{className:"text-xs font-medium text-muted-foreground mb-2 uppercase tracking-wide",children:"SearchableSelect"}),a.jsx(f,{options:_,value:s,onChange:n,label:"Feature",placeholder:"Select a feature"})]}),a.jsxs("div",{children:[a.jsx("p",{className:"text-xs font-medium text-muted-foreground mb-2 uppercase tracking-wide",children:"AsyncSearchableSelect"}),a.jsx(N,{search:{searchFn:c},extractors:o,display:{label:"Customer",placeholder:"Search & select"},value:Na,onChange:Aa})]}),a.jsxs("div",{children:[a.jsx("p",{className:"text-xs font-medium text-muted-foreground mb-2 uppercase tracking-wide",children:"AsyncMultiSearchableSelect"}),a.jsx(A,{search:{searchFn:c},extractors:o,display:{label:"Customers",placeholder:"Search & multi-select"},value:Va,onChange:wa})]})]})}};var L,W,U,q,G;d.parameters={...d.parameters,docs:{...(L=d.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: args => {
...
}`,...(X=(Q=p.parameters)==null?void 0:Q.docs)==null?void 0:X.source},description:{story:"Error state — shown after failed validation (e.g. form submit).",...(ee=(Z=p.parameters)==null?void 0:Z.docs)==null?void 0:ee.description}}};var ae,re,se,te,le;h.parameters={...h.parameters,docs:{...(ae=h.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  render: args => {
...
}`,...(se=(re=h.parameters)==null?void 0:re.docs)==null?void 0:se.source},description:{story:"Pre-selected value — simulates an edit form with existing data.",...(le=(te=h.parameters)==null?void 0:te.docs)==null?void 0:le.description}}};var ce,oe,ne,ie,ue;S.parameters={...S.parameters,docs:{...(ce=S.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ne=(oe=S.parameters)==null?void 0:oe.docs)==null?void 0:ne.source},description:{story:"Disabled — read-only view, e.g. locked subscription fields.",...(ue=(ie=S.parameters)==null?void 0:ie.docs)==null?void 0:ue.description}}};var de,me,pe,he,Se;g.parameters={...g.parameters,docs:{...(de=g.parameters)==null?void 0:de.docs,source:{originalSource:`{
  render: args => {
    const [value, setValue] = useState('');
    return <FlexPriceSelect {...args} value={value} onChange={setValue} />;
  },
...
}`,...(ra=(aa=E.parameters)==null?void 0:aa.docs)==null?void 0:ra.source}}};var sa,ta,la;I.parameters={...I.parameters,docs:{...(sa=I.parameters)==null?void 0:sa.docs,source:{originalSource:`{
...
}`,...(la=(ta=I.parameters)==null?void 0:ta.docs)==null?void 0:la.source}}};var ca,oa,na;F.parameters={...F.parameters,docs:{...(ca=F.parameters)==null?void 0:ca.docs,source:{originalSource:`{
...
}`,...(na=(oa=F.parameters)==null?void 0:oa.docs)==null?void 0:na.source}}};var ia,ua,da;T.parameters={...T.parameters,docs:{...(ia=T.parameters)==null?void 0:ia.docs,source:{originalSource:`{
  ...
  render: () => {
    ...
    return <div className="w-[400px] p-4">\r
        ...
        <p className="mt-2 text-xs text-muted-foreground">\r
          4 selected — 3 shown as badges, 1 in +N overflow\r
        </p>\r
      </div>;
  }
  ...
  render: () => {
    ...
    return <div className="grid grid-cols-2 gap-6 p-4 w-[700px]">\r
        <div>\r
          <p className="text-xs font-medium text-muted-foreground mb-2 uppercase tracking-wide">\r
            Select (Radix)\r
          </p>\r
